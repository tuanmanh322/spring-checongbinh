			...
			<div class="col-md-4 wow tada">
				<center>
					...
					<form action="" method="post">
						<input name="email" style="margin-bottom: 8px;width:100%; color:black;" type="text"
							placeholder="Email" />
							<span>${email }</span>
						<textarea name="noidung" style="width: 100%; color: black;" rows="4"
							placeholder="Nội dung"></textarea>
							<span>${kiemtralienhe }</span>
